! function(a, b) {
    ...
    return function(a) {
        ...
        var d, e;
        d = [], e = function() {
            return "7.3.4+commercial_v7-3-4.78.commercial.ba5b24.jwplayer.6040e1.analytics.5a0154.vast.0300bb.googima.e8ba93.plugin-sharing.08a279.plugin-related.909f55.plugin-gapro.0374cd"
        }.apply(b, d), !(void 0 !== e && (a.exports = e))
    }, function(a, b, c) {
        var d, e;
        d = [], e = function() {
            ...
            function m(m, y) {
                ...
                function E() {
                    ...
                    if (a.width !== Ua.videoWidth || a.height !== Ua.videoHeight) {
                        ...
                        Sa.reason = Sa.reason || "auto", Sa.mode = "hls" === Ba[Ja].type ? "auto" : "manual", Sa.bitrate = 0, a.index = Ja, a.label = Ba[Ja].label, Ca.trigger("visualQuality", Sa), Sa.reason = ""
                    }
                }
                ...
                function W(a) {
                    Na = null, Oa = null, Qa = -1, Pa = -1, Ra = -1, Sa.reason || (Sa.reason = "initial choice", Sa.level = {
                        width: 0,
                        height: 0
                    }), Ea = !1, Aa = !1, Ka = l(xa), Ua.src = xa.file, xa.preload && Ua.setAttribute("preload", xa.preload), b.isIOS() && a && Y(a.tracks)
                }
        ...
        d = [c(66), c(112), c(113), c(48)], e = function(a, b, c, d) {
            var e = function(e, f) {
                ...
                function j(a, b) {
                    if (r = b, s = [], t = {}, u = {}, v = 0, f.mediaController.off("meta", h), f.mediaController.off("subtitlesTracks", g), !d.isIOS()) {
                        var c, e, i, j = b.tracks;
                        for (i = 0; i < j.length; i++) c = j[i], e = c.kind.toLowerCase(), ("captions" === e || "subtitles" === e) && (c.file ? (l(c), m(c)) : c.data && l(c))
                    }
                    0 === s.length && (f.mediaController.on("meta", h, this), f.mediaController.on("subtitlesTracks", g, this));
                    var k = o();
                    this.setCaptionsList(k), p()
                }
